...
ActiveRecord::Schema[8.1].define(version: 2026_07_21_120000) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.date "date"
    t.boolean "default_invited", default: true, null: false
    t.text "description"
    t.string "image"
    t.string "location"
  ...
  create_table "invites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.boolean "do_not_send", default: false, null: false
    t.string "email"
    ...
    t.string "side", default: "groom", null: false
    t.datetime "updated_at", null: false
    t.index ["phone"], name: "index_invites_on_phone"
    t.index ["side"], name: "index_invites_on_side"
  end
